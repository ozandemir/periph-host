...
var mappingH616 = map[string][5]pin.Func{
	...
	"PG15": {"UART2_TX", "", "", "I2C4_SCL", "PG_EINT15"},
	"PG16": {"UART2_RX", "", "", "I2C4_SDA", "PG_EINT16"},
	"PG17": {"UART2_RTS", "", "", "I2C3_SCL", "PG_EINT17"},
	"PG18": {"UART2_CTS", "", "", "I2C3_SDA", "PG_EINT18"},
	"PG19": {"", "", "PWM1", "", "PG_EINT19"},

	"PH0":  {"UART0_TX", "", "PWM3", "I2C1_SCL", "PH_EINT0"},
	"PH1":  {"UART0_RX", "", "PWM4", "I2C1_SDA", "PH_EINT1"},
	"PH2":  {"UART5_TX", "OWA_MCLK", "PWM2", "I2C2_SCL", "PH_EINT2"},
	"PH3":  {"UART5_RX", "", "PWM1", "I2C2_SDA", "PH_EINT3"},
	"PH4":  {"", "OWA_OUT", "", "I2C3_SCL", "PH_EINT4"},
	"PH5":  {"UART2_TX", "H_I2S3_MCLK", "SPI1_CS0", "I2C3_SDA", "PH_EINT5"},
	"PH6":  {"UART2_RX", "H_I2S3_BCLK", "SPI1_CLK", "I2C4_SCL", "PH_EINT6"},
	"PH7":  {"UART2_RTS", "H_I2S3_LRCK", "SPI1_MOSI", "I2C4_SDA", "PH_EINT7"},
	...
	"PI0":  {"RGMII_RXD3", "DMIC_CLK", "H_I2S0_MCLK", "HDMI_SCL", "PI_EINT0"},
	"PI1":  {"RGMII_RXD2", "DMIC_DATA0", "H_I2S0_BCLK", "HDMI_SDA", "PI_EINT1"},
	"PI2":  {"RGMII_RXD1", "DMIC_DATA1", "H_I2S0_LRCK", "HDMI_CEC", "PI_EINT2"},
	"PI3":  {"RGMII_RXD0", "DMIC_DATA2", "H_I2S0_DOUT0", "H_I2S0_DIN1", "PI_EINT3"},
	"PI4":  {"RGMII_RXCK", "DMIC_DATA3", "H_I2S0_DIN0", "H_I2S0_DOUT1", "PI_EINT4"},
	"PI5":  {"RGMII_RXCTL", "UART2_TX", "TS0_CLK", "I2C0_SCL", "PI_EINT5"},
	"PI6":  {"RGMII_NULL", "UART2_RX", "TS0_ERR", "I2C0_SDA", "PI_EINT6"},
	"PI7":  {"RGMII_TXD3", "UART2_RTS", "TS0_SYNC", "I2C1_SCL", "PI_EINT7"},
	"PI8":  {"RGMII_TXD2", "UART2_CTS", "TS0_DVLD", "I2C1_SDA", "PI_EINT8"},
	"PI9":  {"RGMII_TXD1", "UART3_TX", "TS0_D0", "I2C2_SCL", "PI_EINT9"},
	"PI10": {"RGMII_TXD0", "UART3_RX", "TS0_D1", "I2C2_SDA", "PI_EINT10"},
	"PI11": {"RGMII_TXCK", "UART3_RTS", "TS0_D2", "PWM1", "PI_EINT11"},
	"PI12": {"RGMII_TXCTL", "UART3_CTS", "TS0_D3", "PWM2", "PI_EINT12"},
	"PI13": {"RGMII_CLKIN", "UART4_TX", "TS0_D4", "PWM3", "PI_EINT13"},
...
// mapH616Pins uses mappingH616 to actually set the altFunc fields of all gpio
// and mark them as available.
//
// It is called by the generic allwinner processor code if an H616 is detected.
func mapH616Pins() error {
	for name, altFuncs := range mappingH616 {
		pin := cpupins[name]
